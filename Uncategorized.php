...
$query = $con->prepare("SELECT post_id,title,LEFT (body,300)AS body,category_name FROM posts INNER JOIN categories ON categories.category_id = posts.category_id where posts.category_id = 1 order by post_id DESC ");
$query->execute();
